  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown active"> 
            <a data-toggle="dropdown" href="#">MUSIQUE<b class="caret"></b></a>
...
<li class="dropdown-submenu active">
  ...
  <form class="navbar-form navbar-right inline-form">
    ...
    <div class="bg-img" style="background-image: url(img/musiques.png);">
...
<div class="flex-container">
    ...
    <div class="row">
     ...
     <div class="form-group">
    <label for="exampleSelect1" class="bmd-label-floating"><h6>Artiste :</h6></label>
...
if ($db_found) {
 $sql = "SELECT Auteur,Image, Genre FROM musique WHERE Genre='Rap'";
...
$db_found = mysqli_select_db($db_handle, $database);
 ...
 //si le BDD existe, faire le traitement
if ($db_found) {
 $sql = "SELECT Auteur,Image, Genre FROM musique WHERE Genre='Hip-hop'";
 $result = mysqli_query($db_handle, $sql);
 while ($data = mysqli_fetch_assoc($result)) {
 echo "Auteur: " . $data['Auteur'] . '<br>';
  echo "Genre: " . $data['Genre'] . '<br>';
...
$db_found = mysqli_select_db($db_handle, $database);
 ...
 //si le BDD existe, faire le traitement
if ($db_found) {
 $sql = "SELECT Auteur, Image, Genre  FROM musique WHERE Genre='Rock' ";
 $result = mysqli_query($db_handle, $sql);
 while ($data = mysqli_fetch_assoc($result)) {
 echo "Auteur: " . $data['Auteur'] . '<br>';
  echo "Genre: " . $data['Genre'] . '<br>';
