...
<div class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"> 
            <a data-toggle="dropdown active" href="#">SPORT<b class="caret"></b></a>
...
<li class="dropdown-submenu">
      ...
      <ul class="dropdown-menu">
        ...
        <li><a href="index.html#contact">VENDRE</a></li>
  ...
  <form class="navbar-form navbar-right inline-form">
    ...
    <div class="bg-img" style="background-image: url(img/sport.png);">
        <div class="overlay"></div>
		</div>
   
			<div class="header">
              <h1>Tous notre materiel sportif</h1>
        </div>
   ...
   <div class="flex-container">
    ...
    <div class="row">
     ...
     <div class="form-group">
    <label for="exampleSelect1" class="bmd-label-floating"><h6>Catégorie :</h6></label>
    <select class="form-control" id="exampleSelect1">
      <option>Fitness/Musculation</option>
...
if ($db_found) {
 $sql = "SELECT Nom,Image FROM sport WHERE Nom='Appareils abdominaux' OR Nom='Velo de ville'";
...
$db_found = mysqli_select_db($db_handle, $database);
 ...
 //si le BDD existe, faire le traitement
if ($db_found) {
 $sql = "SELECT Nom,Image FROM sport WHERE Nom='Corde a sauter' OR Nom='Barre de Traction'";
 $result = mysqli_query($db_handle, $sql);
 while ($data = mysqli_fetch_assoc($result)) {
 echo "Nom: " . $data['Nom'] . '<br>';
  echo('<img  src="' . $data['Image'] .'" / > <br/>');
...
$db_found = mysqli_select_db($db_handle, $database);
 ...
 //si le BDD existe, faire le traitement
if ($db_found) {
 $sql = "SELECT Nom, Image  FROM sport WHERE Nom='Moulinets peche en mer' OR Nom='Leurres souples'";
 $result = mysqli_query($db_handle, $sql);
 while ($data = mysqli_fetch_assoc($result)) {
 echo "Nom: " . $data['Nom'] . '<br>';
